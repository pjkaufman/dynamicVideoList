...
Window.Vinya.functions.fixBtnDisplay = function fixBtnDisplay(episode) {
  ...
  if (Window.Vinya.videoList[Window.Vinya.defaultList][episode][lang]) {
    // fix the title
    Window.Vinya.DOMElements.videoTitle.innerText = Window.Vinya.videoList[Window.Vinya.defaultList][episode].title;
    ...
    if (Window.Vinya.videoList[Window.Vinya.defaultList][epsiodeFormat + next] != undefined && Window.Vinya.videoList[Window.Vinya.defaultList][epsiodeFormat + next][lang] != undefined ) {
      Window.Vinya.DOMElements.display('nextEpisode');
    } else {
      Window.Vinya.DOMElements.hide('nextEpisode');
    }
    if (Window.Vinya.videoList[Window.Vinya.defaultList][epsiodeFormat + back] != undefined && Window.Vinya.videoList[Window.Vinya.defaultList][epsiodeFormat + back][lang] != undefined) {
...
Window.Vinya.functions.changeVideo = function changeVideo(videoName, languageChanged) {
  if (Window.Vinya.functions.videoPlayerPreCheck(videoName)) {
    ...
    Window.Vinya.player.unload().then(function () {
      Window.Vinya.videoOptions.id = Window.Vinya.videoList[Window.Vinya.defaultList][videoName][Window.Vinya.DOMElements.languages.value];
...
Window.Vinya.functions.parseURL = function parseURL() {
  ...
  var title = params.get(Window.Vinya.URLParams.title), lang = params.get(Window.Vinya.URLParams.lang), time = params.get(Window.Vinya.URLParams.time),
    sub = params.get(Window.Vinya.URLParams.sub), list = params.get(Window.Vinya.URLParams.list);
...
/**
 * Refreshs the video list after the user selects a new video list.
 * @param videoList The name of the video list selected by the user.
 */
Window.Vinya.functions.refreshVideoList = function refreshVideoList(videoList) {
  var newVideoList = '';
